  ...
  return (
    <div className="min-h-screen grid grid-cols-1 md:grid-cols-2">
      <div className="hidden md:block">
        <img
          src="https://plus.unsplash.com/premium_photo-1665520347050-38570519c860?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8Y2hhbGslMjBib2FyZHxlbnwwfHwwfHx8MA%3D%3D"
          alt="Birds on beach at sunset"
      ...
      <div className="flex flex-col justify-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full mx-auto space-y-8">
          <div className="text-center">
            ...
            <h2 className="mt-6 text-3xl font-bold text-gray-900">SignUp</h2>
          </div>
